...
for devItem in devices:
    ...
    result_min = client.query("select * from motion_last_minute where device_id=\'" + devItem + "\' and (gateway_id='c0:98:e5:c0:00:25' or gateway_id='c0:98:e5:c0:00:26' or gateway_id='c0:98:e5:c0:00:03') and time>'2016-09-09 22:00:00' order by time asc limit " + str(rowlimit))
    sys.stdout.write(" - ")
    printTime(datetime.now() - startTime)
    startTime = datetime.now()
    sys.stdout.write("\rQuerying adv data")
    result_adv = client.query("select * from motion_since_last_adv where device_id=\'" + devItem + "\' and (gateway_id='c0:98:e5:c0:00:25' or gateway_id='c0:98:e5:c0:00:26' or gateway_id='c0:98:e5:c0:00:03') and time>'2016-09-09 22:00:00' order by time asc limit " + str(rowlimit))
    sys.stdout.write(" - ")
    printTime(datetime.now() - startTime)
    startTime = datetime.now()
    sys.stdout.write("\rQuerying now data")
    result_now = client.query("select * from current_motion where device_id=\'" + devItem + "\' and (gateway_id='c0:98:e5:c0:00:25' or gateway_id='c0:98:e5:c0:00:26' or gateway_id='c0:98:e5:c0:00:03') and time>'2016-09-09 22:00:00' order by time asc limit " + str(rowlimit))
    sys.stdout.write(" - ")
    printTime(datetime.now() - startTime)
    startTime = datetime.now()
    #print()
